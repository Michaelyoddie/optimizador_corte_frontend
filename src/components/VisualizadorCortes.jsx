...
const VisualizadorCortes = ({ config, resultados }) => {
  ...
  const exportarPDF = useReactToPrint({
    ...
    documentTitle: `Proyecto_Optimizador_Cortes`,
  });
  ...
  // 1. Lógica para la PANTALLA (Calcula solo la plancha actual)
  ...
  return (
    <div className="w-full flex flex-col h-full overflow-hidden relative">
      ...
      {/* --- VISTA DE PANTALLA INTERACTIVA (Solo 1 plancha visible) --- */}
      <div className="flex flex-col flex-1 min-h-0 bg-white p-2 rounded-lg">
        {/* Mapa SVG de Pantalla */}
      ...
      {/* ========================================================================= */}
      {/* --- VISTA OCULTA PARA IMPRIMIR (Todas las planchas con salto de página) --- */}
      {/* ========================================================================= */}
      <div className="hidden">
        <div ref={componentePDFRef} className="p-8 bg-white text-black">
          {resultados.detalle_planchas.map((plancha, planchaIndex) => {

            // Calculamos la tabla específicamente para la plancha que estamos dibujando en este ciclo
            ...
            return (
              // "break-after-page" obliga a saltar de hoja después de cada plancha
              <div key={planchaIndex} className="break-after-page mb-16">
                
                {/* Título de la hoja */}
                <div className="mb-6 text-center border-b-2 border-gray-800 pb-4">
                  <h1 className="text-2xl font-bold text-gray-800 uppercase tracking-wide">Hoja de Ruta - Optimizador</h1>
                ...
                {/* Mapa SVG optimizado para papel */}
                ...
                {/* Tabla de cortes firme y sólida para papel */}
                <div>
